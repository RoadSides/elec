...
var bar1 = new Q6MenuBar("bar1", "红树飘香网络图书商城");
function load() {
	bar1.colorStyle = 2;
	...
	bar1.add("订单管理", "未付款订单", "<c:url value='/admin/AdminOrderServlet?method=nonpayment'/>", "body");
	bar1.add("订单管理", "已付款订单", "<c:url value='/admin/AdminOrderServlet?method=haspayment'/>", "body");
	bar1.add("订单管理", "未收货订单", "<c:url value='/admin/AdminOrderServlet?method=nonreceive'/>", "body");
	bar1.add("订单管理", "已完成订单", "<c:url value='/admin/AdminOrderServlet?method=complete'/>", "body");
