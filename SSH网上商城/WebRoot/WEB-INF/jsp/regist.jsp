...
<script >
			...
			function findByName(){
					...
					//3.打开连接
					xhr.open("GET","<c:url value='user_findByName?time="+new Date().getTime+"&username="+username+"'/>",true);
					//4.发送
					xhr.send(null);
			};
			...
			function change(){
					...
					img1.src="<c:url value='checkImage?date="+new Date().getTime()+"'/>";
			};
</script>
</head>
<body>
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					</div><span style="color:red"><s:actionerror /> </span>
					<form id="registerForm"  action="<c:url value='user_regist.action'/>"  method="post"  novalidate="novalidate"  onsubmit="return checkForm();"/>
						<table>
							<tbody><tr>
								<th>
								...
								<td>
									<input type="text" id="username" name="username" class="text" maxlength="20"   onblur="findByName();"/><span id="span1"></span>
								</td>
							</tr>
							<tr>
								<th>
							...
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" autocomplete="off"/><img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/checkImage"  onclick="change()" title="点击更换验证码"/>
										</span>
									</td>
								</tr>
							<tr>
...
<div id="_my97DP" style="position: absolute; top: -1970px; left: -1970px;"><iframe style="width: 190px; height: 191px;" src="./会员注册 - Powered By Mango Team_files/My97DatePicker.htm" frameborder="0" border="0" scrolling="no"/></div></body></html>