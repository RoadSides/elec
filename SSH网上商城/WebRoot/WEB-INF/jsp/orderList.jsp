					...
					<s:iterator value="pageBean.list"  var="order">
						<tr>
								<th colspan="5">订单编号:<s:property value="#order.oid"/>&nbsp;&nbsp;&nbsp;
											...
											<s:if test="#order.state==3"><a href="${pageContext.request.contextPath}/order_updateState.action?oid=<s:property value="#order.oid"/>"><font color="red">确认收货</font></a></s:if>
